package com.hexagonaldemo.hotelapi.common.rest;

import com.hexagonaldemo.hotelapi.common.exception.HotelApiBusinessException;
...
public class RestExceptionHandler extends BaseController {
    ...
    @ExceptionHandler(HotelApiBusinessException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Response<ErrorResponse> handleAuthServerBusinessException(HotelApiBusinessException ex, Locale locale) {
