package com.demohotel.reservationapi.common.rest;

import com.demohotel.reservationapi.common.exception.ReservationApiBusinessException;
...
public class RestExceptionHandler extends BaseController {
    ...
    @ExceptionHandler(ReservationApiBusinessException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Response<ErrorResponse> handleAuthServerBusinessException(ReservationApiBusinessException ex, Locale locale) {
